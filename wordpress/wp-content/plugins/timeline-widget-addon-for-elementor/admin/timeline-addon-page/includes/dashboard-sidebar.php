...
?>
 ...
 <div class="cool-body-right">
	...
	<ul>
	  ...
	  echo esc_html__( 'Cool Plugins develops best timeline plugins for WordPress.', 'twae' ); ?></li>
	  <li><?php 
	  // phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
	  /* translators: %1$s: opening bold tag, %2$s: closing bold tag */ printf( esc_html__( 'Our timeline plugins have %1$s50000+%2$s active installs.', 'cool-timeline' ), '<b>', '</b>' ); ?></li>
	  <li>
		<?php 
		// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
		echo esc_html__( 'For any query or support, please contact plugin support team.', 'twae' ); ?>
		<br><br>
		<a href="<?php echo esc_url( $twae_support_email ); ?>" target="_blank" class="button button-secondary">
			<?php 
			// phpcs:ignore WordPress.WP.I18n.TextDomainMismatch
			echo esc_html__( 'Premium Plugin Support', 'twae' ); ?>
		</a>
		<br><br>
	  </li>
	</ul>
